    ...
    return (
        <div className="w-[1450px] relative mx-auto bg-gray-2x00">
            ...
            <div className="absolute ">
                ...
                <label htmlFor="manage"><img onClick={() => ListRouter()} className='w-10 active:rotate-[45deg] duration-100 cursor-pointer' src="../../image/cogwheel.png" alt="" /></label>
            ...
            <div className=" w-[1300px] mx-auto h-[50px] mt-5 mb-10 ">
                <img className='sm:w-[600px] md:w-[900px] xl:w-auto' src="../../image/cooltext440442067129196.png" alt="" />
            </div>
